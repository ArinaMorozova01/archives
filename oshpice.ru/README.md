...
## wpull 
Архивация при помощи wpull не вызвала каких-либо проблем, это самый маленький сайт из коллекции, архивировался он меньше получаса.

Проверка через Replay Webpage также прошла успешно, картинки сохранены, все разделы кликабельны, на сайте присутствует возможность оставлять комментарии, однако ни одного комментария никто так и не оставил, а следовательно на сохранение это никак не повлияло.

![Replay](replay-oshpice.ru.png)

Общий вес warc-файла составил 106 Мб.
