...
Остальные сайты из коллекции архивировались аналогично и результаты архивации там будут схожи.
